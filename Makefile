all: rvv_ld_st rvv_int_arith rvv_fixed_point rvv_floating_point rvv_reduction run
...
clean:
	-rm rvv_ld_st rvv_int_arith rvv_fixed_point rvv_floating_point rvv_reduction
